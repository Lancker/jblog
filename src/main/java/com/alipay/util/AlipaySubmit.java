...
public class AlipaySubmit {
	...
	public String buildRequestMysign(Map<String, String> sPara) {
		...
		if (AlipayConfig.sign_type.equals("MD5")) {
			mysign = MD5.sign(prestr, alipayConfig.getKey(), AlipayConfig.input_charset);
		}
		return mysign;
	}
	...
	public String query_timestamp() throws MalformedURLException, DocumentException, IOException {
		...
		String strUrl = ALIPAY_GATEWAY_NEW + "service=query_timestamp&partner=" + alipayConfig.getPartner()
