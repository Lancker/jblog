...
public class AdminController {
	...
	public Result<String> setBlogClass(@RequestParam("postCode") Integer postCode,
	...
	public Result<String> editBlogClass(@RequestParam("classCode") Integer classCode,
	...
	public Result<String> wechatLogin(Model model,String code) throws TemplateModelException,IOException {
		logger.info("微信扫码登陆 ");
